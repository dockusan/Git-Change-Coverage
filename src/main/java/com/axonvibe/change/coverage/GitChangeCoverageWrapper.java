...
public class GitChangeCoverageWrapper extends Recorder {
	...
	public GitChangeCoverageWrapper(String sourceBranch, String targetBranch, String reportFilePath) {
...
//		});
		...
		if (pushResultToGitlab) {
			...
			String commitHash = envVars.get("GIT_COMMIT") != null ? envVars.get("GIT_COMMIT") : GitDiffParser.getLastHash(srcBranch, workSpace);
			GitlabClient.pushResultToGitlab(gitlabToken, gitlabUrl, gitlabProjectId, 
					commitHash, buildResult, jenkinName, 
					result.getInstructionConveredPercent(), envVars.get("BUILD_URL"), 
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
		...
		public FormValidation doCheckGitlabUrl(@QueryParameter String gitlabUrl, @QueryParameter boolean pushResultToGitlab) {
		...
		public FormValidation doCheckGitlabProjectId(@QueryParameter String gitlabProjectId, @QueryParameter boolean pushResultToGitlab) {
		...
		public FormValidation doCheckGitlabToken(@QueryParameter String gitlabToken, @QueryParameter boolean pushResultToGitlab) {
		...
		public FormValidation doCheckJenkinName(@QueryParameter String jenkinName, @QueryParameter boolean pushResultToGitlab) {
